 ...
 */
export function createDebugParser(userMap: Record<string, string> = {}, emojiMap: Record<string, string> = {}): IntelligentMessageParser {
 ...
 */
export function createProductionParser(userMap: Record<string, string> = {}, emojiMap: Record<string, string> = {}): IntelligentMessageParser {
    return createIntelligentParser({
        debug: false,
        userMap,
        emojiMap
 ...
 */
export function createParserWithUsers(userMappings: Record<string, string>): IntelligentMessageParser {
    return createIntelligentParser({
        debug: false,
...
export function createPerformanceTestSetup(config: TestParserConfig = {}): {
    ...
    timeMultipleExecutions: (fn: () => any, iterations: number) => { results: any[]; times: number[]; avgTime: number };
} {
