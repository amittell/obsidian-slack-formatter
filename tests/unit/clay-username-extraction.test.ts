...
import { isAppMessage, extractAppUsername, extractUsername, MessageFormat } from '../../src/utils/username-utils.js';
...
describe('Clay Username Extraction', () => {
    ...
    describe('IntelligentMessageParser.extractUserAndTime', () => {
        ...
        test('should extract Clay and timestamp from app format with timestamp', () => {
            const clayWithTimestamp = " (https://app.slack.com/services/B071TQU3SAH)Clay Jun 8th at 6:28 PM";
