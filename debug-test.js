import { FlexibleMessageParser } from './dist/formatter/stages/flexible-message-parser.js';
...
const result = parser.parse(testInput, true);

console.log("=== PARSED MESSAGES ===");
result.forEach((msg, i) => {
    console.log(`Message ${i}: ${msg.username} at ${msg.timestamp}`);
